...
if showAuditPanel and barstate.islast
    table.cell(auditPanel, 0, 0, "Brutus Playbook raw-parity-v9", text_color=color.white, bgcolor=color.new(color.black, 0))
          ...
          <div className="grid gap-3 border border-cyan-500/40 bg-cyan-500/5 p-4 text-sm md:grid-cols-4">
            ...
            <div>
              ...
              <p className="mt-1 text-muted-foreground">
                ...
                evidence, not perfect historical replay. The v9 script alerts
