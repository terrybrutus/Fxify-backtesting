...
const LATEST_PLAYBOOK_VERSION = "raw-parity-v13";
...
// Alert coverage: confirmed-close mode sends one JSON packet for every confirmed raw signal. First-touch mode sends at most one JSON decision packet per bar, plus separate TP/stop outcome packets.
...
if showAuditPanel and barstate.islast
    table.cell(auditPanel, 0, 0, "Brutus Playbook raw-parity-v13", text_color=color.white, bgcolor=color.new(color.black, 0))
