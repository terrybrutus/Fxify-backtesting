...
const LATEST_PLAYBOOK_VERSION = "raw-parity-v20";
...
if showAuditPanel and barstate.islast
    table.cell(auditPanel, 0, 0, "Brutus Playbook raw-parity-v20", text_color=color.white, bgcolor=color.new(color.black, 0))
